...
extension BuiltInPermission {
    ...
    static var mediaLibrary: Self { make(.mediaLibrary, "Media Library", "Access your music and media library.", ["NSAppleMusicUsageDescription"], platforms: [.iOS, .macOS], read: NativePermissions.mediaLibraryStatus, request: NativePermissions.requestMediaLibrary) }
